...
public class MatchServiceImpl implements MatchService {
    ...
    public List<Match> getAllUpcomingMatches() {
        Query query = entityManager.createNativeQuery("SELECT * FROM match WHERE status = ? and schedule_date > CURRENT_TIMESTAMP AT TIME ZONE 'UTC' ORDER BY schedule_date ASC", Match.class);
